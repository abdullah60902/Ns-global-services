...
import logo from '@/../../public/image/logo-wa.jpg'
...
const Whatsapp = () => {
  ...
  const [message, setMessage] = useState(
    "Hello! I have questions regarding NS Global Services"
  );
  const [showEmojis, setShowEmojis] = useState(false);
const phoneNumber = "+35794554049";
  ...
  className="fixed bottom-30 right-5 z-50 flex items-center justify-center bg-green-500 text-white w-14 h-14 rounded-full shadow-lg hover:bg-green-600 transition-transform transform hover:scale-105 bounce-animation"
...
`}</style>
      ...
      {isChatVisible && (
        <div
          ref={chatRef}
          className="fixed bottom-[185px] right-4 z-50 bg-[#ece5dd] w-64 sm:w-80 max-w-full rounded-lg shadow-2xl border border-gray-300"
        >
          {/* Chat Header */}
          <div className="bg-[#075e54] text-white p-3 rounded-t-lg flex justify-between items-center">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-sm font-bold">NS Global Services</p>
